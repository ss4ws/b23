...
If you choose to use this OER I would like to hear from you. Your feedback and experiences, will help me improve and update the resource for the benefit of the wider French teaching community.

## Getting Started

You can explore the OER online or download the PDF of the entire course. If you want to download individual pages/files please visit [the Github page of the project](https://github.com/ss4ws/b23/tree/docs).

## Acknowledgment

This project is created with the generous support of the [Affordability & Equity Grants at the UVA library](https://library.virginia.edu/services/faculty/equity) funded by the Jefferson Trust.
